...
function AuditTrailPortal({ open, onClose, palette }) {
  ...
  const events = [
    ...
    { ts: "13:55:09", date: "30/04/2026", agent: "secescolar.aracaju", finalidade: "histórico_clínico", cidadao: "***222.333**", retorno: "—", status: "BLOCKED", ip: "200.150.42.18", duracao: "12ms", motivo: "Finalidade fora do escopo autorizado" },
    { ts: "13:53:41", date: "30/04/2026", agent: "secescolar.aracaju", finalidade: "matrícula", cidadao: "***888.999**", retorno: "LIBERADO", status: "OK", ip: "200.150.42.18", duracao: "176ms" },
  ];
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div className="mono-font" style={{ marginLeft: 12, fontSize: 8, color: palette.textMuted, letterSpacing: "0.1em" }}>
                imunizaju.aracaju.gov.br/consulta
              </div>
            </div>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div className="mono-font" style={{ fontSize: 12, fontWeight: 600, color: palette.text, letterSpacing: "0.05em" }}>
              imunizaju.aracaju.gov.br/audit
            </div>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
...
function DemonstracaoPratica({ palette }) {
  ...
  const [mobileView, setMobileView] = useState("familia"); // 'familia' | 'escola' — só usado em mobile
    ...
    <SectionWrap palette={palette} id="demonstracao">
        ...
        <AnimatePresence mode="wait">
          ...
          {(step === 2 || step === 4) && resultado && (
            ...
            >
              ...
              {/* TOGGLE DE VISÕES — apenas em mobile */}
              <div className="visao-toggle" style={{
                display: "none",
                gap: 8,
                marginBottom: 12,
                padding: 4,
                ...
                <button
                  onClick={() => setMobileView("familia")}
                  style={{
                    flex: 1,
                    padding: "10px 14px",
                    background: mobileView === "familia" ? palette.success : "transparent",
                    color: mobileView === "familia" ? "#fff" : palette.textMuted,
                    border: "none",
                    borderRadius: 8,
                    fontSize: 12,
                    fontWeight: 600,
                ...
                <button
                  onClick={() => setMobileView("escola")}
                  style={{
                    flex: 1,
                    padding: "10px 14px",
                    background: mobileView === "escola" ? palette.primary : "transparent",
                    color: mobileView === "escola" ? "#fff" : palette.textMuted,
                    border: "none",
                    borderRadius: 8,
                    fontSize: 12,
                    fontWeight: 600,
              ...
              {/* Grid de duas visões */}
              <div className="visao-dupla-grid" data-mobile-view={mobileView} style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                {/* COLUNA 1: Visão Família/UBS */}
                <motion.div
                  className="visao-col visao-familia"
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
                ...
                <motion.div
                  className="visao-col visao-escola"
                  initial={{ opacity: 0, x: 20 }}
                  animate={{ opacity: 1, x: 0 }}
      ...
      <style>{`
        @media (max-width: 880px) {
          ...
          .visao-toggle { display: flex !important; }
          .visao-dupla-grid[data-mobile-view="familia"] .visao-escola { display: none !important; }
          .visao-dupla-grid[data-mobile-view="escola"] .visao-familia { display: none !important; }
        }
      `}</style>
    </SectionWrap>
  );
