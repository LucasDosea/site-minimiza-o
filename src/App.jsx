  ...
  return (
    ...
    >
      ...
      <BigTypeTransition
        palette={palette}
        word="MINIMIZAR"
        subword="quanto menos dado circula, mais cidadão é respeitado"
      />
      ...
      <BigTypeTransition
        palette={palette}
        word="THRESHOLD"
        subword="o limiar entre o que se sabe e o que se mostra"
      />
      <AlinhamentoDesafio palette={palette} />
      <DashboardExecutivo palette={palette} />
      <ConsultaEscolar palette={palette} openPortal={openPortalFn} />
      <RegistroSaude palette={palette} />
      <LGPDMinimizacao palette={palette} openPortal={openPortalFn} />
      <AuditoriaDemo palette={palette} openPortal={openPortalFn} />
      <BigTypeTransition
        palette={palette}
        word="EVIDÊNCIA"
        subword="cada acesso registrado, cada finalidade declarada"
      />
      <ImpactoSocial palette={palette} />
      <RoteiroApresentacao palette={palette} />
      ...
      {/* Deep dive portals */}
      <CryptographyPortal
        open={openPortal === 'crypto'}
        onClose={closePortal}
        palette={palette}
      />
      <MinimizationPortal
        open={openPortal === 'minimization'}
        onClose={closePortal}
        palette={palette}
      />
      <AuditTrailPortal
        open={openPortal === 'audit'}
        onClose={closePortal}
        palette={palette}
      />
    </div>
...
function CryptographyPortal({ open, onClose, palette }) {
  ...
  return (
    ...
    >
      ...
      >
        Quando a Educação consulta o status, o CPF do cidadão nunca chega ao
        banco pseudonimizado em texto puro. Ele passa por uma função
        criptográfica que produz um{' '}
        <strong style={{ color: palette.text }}>token irreversível</strong> —
        usado apenas naquela consulta, então descartado.
      </p>
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          >
            Função hash unidirecional. Impossível recuperar o CPF a partir do
            token.
          </div>
        </div>
        ...
        {phase >= 2 && (
          ...
          >
            <div style={{ fontSize: 14, color: palette.text, lineHeight: 1.7 }}>
              ...
              mesmo que o banco de dados da Educação fosse comprometido, ninguém
              conseguiria descobrir QUAIS cidadãos foram consultados. Os tokens
              não revelam nada — são "etiquetas" sem significado isolado.
            </div>
          </motion.div>
        )}
      </div>
        ...
        {[
          {
            ...
            desc: 'Hash SHA-256 não pode ser revertido em CPF original.',
          },
          {
            icon: Shield,
            title: 'Salt único',
            desc: 'Cada consulta usa um salt diferente. Tokens nunca se repetem.',
          },
          {
            icon: Eye,
            title: 'Escopo limitado',
            desc: 'Token só é válido naquela transação. Expira em segundos.',
          },
          {
            icon: ScrollText,
            title: 'Auditável',
            desc: 'A geração do hash em si é registrada com finalidade declarada.',
          },
        ].map((p, i) => {
          const Icon = p.icon;
          return (
            ...
            >
              ...
              <h4
                className="display-font"
                style={{ fontSize: 17, fontWeight: 500, margin: '0 0 8px' }}
              >
                {p.title}
              </h4>
              <p
...
function MinimizationPortal({ open, onClose, palette }) {
  ...
  const prontuarioCompleto = [
    ...
    },
    {
      ...
      valor: 'Unimed Aracaju',
      tipo: 'financeiro',
      criticidade: 3,
    },
    {
      campo: 'Histórico de doenças',
      valor: 'Asma leve · Alergia a leite',
      tipo: 'clínico',
      criticidade: 5,
    },
    {
      campo: 'Medicamentos uso contínuo',
      valor: 'Salbutamol spray',
      tipo: 'clínico',
      criticidade: 5,
    },
    {
    ...
    {
      campo: 'Última consulta médica',
      valor: '15/03/2026 — clínica geral',
      tipo: 'clínico',
      criticidade: 4,
    },
    {
      campo: 'Vacina Tríplice Viral',
      valor: 'Aplicada 12/04/2024',
      tipo: 'vacinal',
      criticidade: 2,
    },
    {
      campo: 'Vacina Hepatite B',
      valor: 'Aplicada 03/06/2018',
      tipo: 'vacinal',
      criticidade: 2,
    },
    {
      campo: 'Vacina HPV',
      valor: 'Aplicada 22/09/2025',
      tipo: 'vacinal',
      criticidade: 2,
    },
    {
      campo: 'Vacina Meningocócica',
      valor: 'Aplicada 10/05/2023',
      tipo: 'vacinal',
      criticidade: 2,
    },
    {
      campo: 'Status calendário vacinal',
      valor: 'Em dia para a faixa etária',
      tipo: 'status',
      criticidade: 1,
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        Este é o prontuário completo de uma criança fictícia. Acompanhe o que{' '}
        <strong style={{ color: palette.text }}>desaparece</strong> camada por
        camada quando aplicamos o princípio da minimização — até sobrar apenas o
        necessário para autorizar matrícula.
      </p>
      ...
      >
        ...
        <div
          className="mono-font"
          style={{ fontSize: 14, color: palette.warn, letterSpacing: '0.2em' }}
        >
          {filterStep}/5
        </div>
      </div>
          ...
          return (
            <motion.div
              ...
              style={{
                ...
                padding: '14px 20px',
                borderBottom:
                  i < prontuarioCompleto.length - 1
                    ? `1px solid ${palette.border}`
                    : 'none',
                position: 'relative',
                background:
                  item.tipo === 'status' && filterStep >= 5
                    ? palette.success + '11'
                    : 'transparent',
            ...
            >
              ...
              <div
                ...
                style={{
                  fontSize: 9,
                  color: filtered ? palette.danger : palette.textMuted,
                  letterSpacing: '0.15em',
                  padding: '2px 8px',
                  border: `1px solid ${
                    filtered ? palette.danger : palette.border
                  }`,
                  borderRadius: 100,
                }}
              >
      ...
      {filterStep >= 5 && (
        ...
        >
          ...
          >
            De 15 campos do prontuário, apenas{' '}
            <strong style={{ color: palette.text }}>1 status calculado</strong>{' '}
            chega à Educação. Sem nome, sem CPF, sem doenças, sem medicamentos —
            apenas a resposta à pergunta pública específica.
          </p>
        </motion.div>
      )}
...
function AuditTrailPortal({ open, onClose, palette }) {
  ...
  const events = [
    ...
    },
    {
      ts: '13:58:22',
      date: '30/04/2026',
      agent: 'saude.ubs.atalaia',
      finalidade: 'atendimento',
      cidadao: '***222.333**',
      retorno: 'histórico_completo',
      status: 'OK',
      ip: '192.168.1.45',
      duracao: '418ms',
    },
    {
      ...
      ip: '200.150.42.18',
      duracao: '12ms',
      motivo: 'Finalidade fora do escopo autorizado',
    },
    {
      ts: '13:53:41',
      date: '30/04/2026',
  ...
  return (
    ...
    >
      ...
      >
        A auditoria não é um log de texto comum. Cada evento é registrado com{' '}
        <strong style={{ color: palette.text }}>seis dimensões</strong> que
        permitem investigação posterior: quem acessou, com qual finalidade, em
        qual horário, de qual IP, quanto tempo levou e o que retornou.
      </p>
      ...
      >
        ...
        {/* Timeline de eventos */}
        <div
          style={{ position: 'relative', paddingLeft: 32, marginBottom: 32 }}
        >
          {/* Linha vertical */}
          <div
            style={{
              ...
              >
                ...
                <div
                  style={{
                    ...
                    boxShadow: selected
                      ? `0 0 0 3px ${blocked ? palette.danger : palette.accent}`
                      : 'none',
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: 13, color: palette.text }}>
                      ...
                      <strong
                        style={{
                          color: blocked ? palette.danger : palette.text,
                        }}
                      >
                        {ev.finalidade}
                      </strong>
      ...
      >
        <div
          ...
          style={{
            fontSize: 11,
            color: isBlocked ? palette.danger : palette.accent,
            letterSpacing: '0.3em',
            marginBottom: 24,
          }}
        >
          ─ DETALHES FORENSES · EVENT #
          {String(selectedEvent + 1).padStart(4, '0')}
        </div>
        ...
        >
          {[
            {
              label: 'TIMESTAMP',
              value: `${event.date} ${event.ts}`,
              mono: true,
            },
            { label: 'AGENTE', value: event.agent, mono: true },
            {
              label: 'FINALIDADE',
              value: event.finalidade,
              color: isBlocked ? palette.danger : palette.text,
            },
            ...
            {
              label: 'STATUS HTTP',
              value: isBlocked ? '403 Forbidden' : '200 OK',
              mono: true,
              color: isBlocked ? palette.danger : palette.success,
            },
          ].map((field, i) => (
            <div key={i}>
              <div
        ...
        {isBlocked && event.motivo && (
          ...
          >
            ...
            <div style={{ fontSize: 14, color: palette.text, lineHeight: 1.6 }}>
              {event.motivo}. A tentativa foi registrada permanentemente e pode
              ser usada como evidência em auditoria pela autoridade de proteção
              de dados.
            </div>
          </div>
        )}
  ...
  return (
    ...
    >
      ...
      >
          ...
          {words.map((word, i) => (
            <motion.span
              ...
              style={{
                display: 'inline-block',
                marginRight: '0.25em',
                color: ['registra.', 'calcula.', 'consulta'].includes(word)
                  ? palette.accent
                  : 'inherit',
                fontStyle: ['registra.', 'calcula.', 'consulta'].includes(word)
                  ? 'italic'
                  : 'normal',
              }}
            >
        ...
        >
          Uma demonstração visual de como integração entre secretarias pode
          reduzir burocracia, papel e exposição de dados sensíveis — entregando
          à família apenas o que é necessário para a matrícula escolar.
        </motion.p>
        ...
        >
          <a
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = `0 10px 30px -10px ${palette.text}`;
            }}
            onMouseLeave={(e) => {
        ...
        >
          {[
            ...
            <div key={i}>
              <div
                className="display-font"
                style={{ fontSize: 36, fontWeight: 600, color: palette.text }}
              >
                {s.num}
              </div>
              <div
          ...
          >
            ...
            >
                    ...
                    >
                      <div
                        style={{
                          ...
                          animation: bar.blocked
                            ? 'none'
                            : `bar-load 3s ease-in-out infinite`,
              ...
              >
                {[
                  {
                    txt: '› GET /api/status?id=***',
                    color: palette.textMuted,
                    anim: 'notebook-line-fade-1',
                  },
                  {
                    txt: '‹ 200 OK · status_only',
                    color: palette.success,
                    anim: 'notebook-line-fade-2',
                  },
                  {
                    txt: '‹ audit.log · timestamp saved',
                    color: palette.accent,
                    anim: 'notebook-line-fade-1',
                  },
                ].map((line, i) => (
        ...
        {[
          ...
          <div
            ...
            style={{
              ...
              animation: row.keep
                ? 'none'
                : 'data-row-cycle 6s ease-in-out infinite',
      ...
      >
        ...
        <div style={{ position: 'relative', height: 160, overflow: 'hidden' }}>
          {[
            ...
            >
              <span style={{ color: palette.textMuted, minWidth: 56 }}>
                {log.ts}
              </span>
              <span
                style={{
...
function SectionHeader({ palette, kicker, title, subtitle }) {
  ...
  return (
    <div
      ref={ref}
      style={{ maxWidth: 800, margin: '0 auto 64px', textAlign: 'center' }}
    >
      <motion.div
        initial={{ opacity: 0, y: 20 }}
...
function SectionWrap({ children, palette, alt = false, id, animation = null }) {
  return (
    <section
      ...
      style={{
        padding: '120px 32px',
        background: alt ? palette.bgAlt : palette.bg,
        position: 'relative',
        overflow: 'hidden',
      }}
    >
...
function ProblemaPublico({ palette }) {
  const problems = [
    {
      icon: FileText,
      title: 'Papel circulando entre órgãos',
      desc: 'Caderneta de vacinação física exigida fisicamente na escola, gerando perda, dano e fraude.',
    },
    {
      icon: Clock,
      title: 'Filas presenciais evitáveis',
      desc: 'Famílias se deslocam à UBS apenas para emitir comprovante, ocupando vaga clínica.',
    },
    {
      icon: AlertCircle,
      title: 'Exposição desnecessária',
      desc: 'Histórico clínico completo apresentado quando bastaria um status de conformidade.',
    },
    {
      icon: Layers,
      title: 'Retrabalho administrativo',
      desc: 'Servidores conferindo manualmente documentos que poderiam ser validados por sistema.',
    },
  ];
  const ref = useRef(null);
        ...
        {problems.map((p, i) => {
          ...
          return (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              onMouseEnter={(e) =>
                (e.currentTarget.style.borderColor = palette.danger + '66')
              }
              onMouseLeave={(e) =>
...
function SolucaoProposta({ palette }) {
  ...
  const pillars = [
    {
      icon: Database,
      title: 'Banco pseudonimizado',
      desc: 'Dados clínicos permanecem na Saúde. Educação consulta apenas o status calculado.',
    },
    {
      icon: Lock,
      title: 'Minimização por design',
      desc: 'Cada órgão acessa o mínimo necessário para sua função pública específica.',
    },
    {
      icon: GitBranch,
      title: 'Integração orquestrada',
      desc: 'Comunicação por API entre secretarias, sem duplicação de cadastros.',
    },
    {
      icon: ScrollText,
      title: 'Auditoria contínua',
      desc: 'Cada consulta registrada com finalidade, agente e dado acessado.',
    },
  ];
        ...
        {pillars.map((p, i) => {
          ...
          return (
            <motion.div
              ...
              whileHover={{
                y: -8,
                boxShadow: `0 30px 60px -20px ${palette.primary}33`,
              }}
...
function AntesDepois({ palette }) {
  ...
  const antes = [
    'Família imprime caderneta na UBS',
    'Levam papel à secretaria escolar',
    'Servidor confere visualmente',
    'Histórico clínico exposto',
    'Risco de extravio e fraude',
    'Múltiplas idas presenciais',
  ];
  const depois = [
    'Saúde mantém registro digital',
    'Sistema calcula status objetivo',
    'Educação consulta apenas LIBERADO/PENDENTE',
    'Histórico clínico permanece na Saúde',
    'Auditoria automática de cada consulta',
    'Família resolve em um clique',
  ];
        ...
        {[
          {
            ...
            icon: X,
            title: 'Modelo atual',
            subtitle: 'Burocrático e exposto',
          },
          {
            data: depois,
            color: palette.success,
            icon: Check,
            title: 'Modelo proposto',
            subtitle: 'Digital e minimizado',
          },
        ].map((col, idx) => {
          const Icon = col.icon;
          return (
...
function FocusGallery({ palette }) {
  ...
  const cards = [
    {
      titulo: 'Família',
      desc: 'Acompanha vacinação pelo app, sem precisar imprimir nada para a escola.',
      icon: Users,
      color: palette.primary,
    },
    {
      titulo: 'UBS / Saúde',
      desc: 'Registra dose aplicada e mantém o histórico clínico em seu domínio.',
      icon: Heart,
      color: palette.danger,
    },
    {
      titulo: 'Banco pseudonimizado',
      desc: 'Calcula status objetivo a partir do registro, sem expor dados clínicos.',
      icon: Database,
      color: palette.accent,
    },
    {
      titulo: 'Educação',
      desc: 'Consulta apenas LIBERADO, EM DIA, PENDENTE ou NÃO LOCALIZADO.',
      icon: GraduationCap,
      color: palette.success,
    },
    {
      titulo: 'Matrícula',
      desc: 'Família é orientada conforme status; pendência vira agendamento, não barreira.',
      icon: BookOpen,
      color: palette.warn,
    },
  ];
        ...
        {cards.map((c, i) => {
          ...
          return (
            ...
            >
              ...
              <h3
                className="display-font"
                style={{ fontSize: 22, fontWeight: 500, margin: '0 0 10px' }}
              >
                {c.titulo}
              </h3>
              <p
...
function FluxoSolucao({ palette }) {
  ...
  const passos = [
    {
      label: 'Família',
      sub: 'Cidadão com vacinação em dia ou não',
      icon: Users,
    },
    {
      label: 'UBS / Saúde',
      sub: 'Registra ou valida dose aplicada',
      icon: Heart,
    },
    {
      label: 'Banco pseudonimizado',
      sub: 'Calcula status objetivo',
      icon: Database,
    },
    { label: 'Educação', sub: 'Consulta apenas o status', icon: GraduationCap },
    {
      label: 'Matrícula orientada',
      sub: 'Liberada ou orientada conforme status',
      icon: BookOpen,
    },
  ];
  ...
  const items = [
    {
      ...
      desc: 'Serviço público entregue por canais digitais com identidade unificada.',
    },
    {
      icon: GitBranch,
      title: 'Interoperabilidade',
      desc: 'Comunicação entre secretarias por API, sem duplicar bases.',
    },
    {
      icon: Shield,
      title: 'LGPD',
      desc: 'Princípios de finalidade, necessidade e minimização aplicados por design.',
    },
    {
      icon: TrendingUp,
      title: 'Valor público',
      desc: 'Tempo do cidadão preservado e exposição de dados reduzida.',
    },
  ];
...
function DashboardExecutivo({ palette }) {
  ...
  const metrics = [
    ...
    },
    {
      ...
      color: palette.success,
      progress: 78,
      sub: 'Dose calendário em dia',
    },
    {
      label: 'Pendências resolvidas em até 7 dias',
      value: 86,
      suffix: '%',
      color: palette.accent,
      progress: 86,
      sub: 'Sem barreira à matrícula',
    },
    {
      label: 'Idas presenciais evitadas',
      value: 31200,
      suffix: '',
      color: palette.primary,
      progress: 88,
      sub: 'Estimativa demonstrativa',
    },
    {
      label: 'Documentos em papel',
      value: 0,
      suffix: '',
      color: palette.success,
      progress: 100,
      sub: 'Zero impressão exigida',
    },
    {
      label: 'Consultas auditadas',
      value: 100,
      suffix: '%',
      color: palette.primaryDeep,
      progress: 100,
      sub: 'Cada acesso registrado',
    },
  ];
      ...
      >
        {metrics.map((m, i) => (
          ...
          >
            ...
            />
            <div
              style={{ fontSize: 12, color: palette.textMuted, marginTop: 12 }}
            >
              {m.sub}
            </div>
          </motion.div>
...
// ============================================
// 9. CONSULTA ESCOLAR SIMULADA (com agendamento UBS)
// ============================================
function ConsultaEscolar({ palette, openPortal }) {
  ...
  const exemplos = [
    {
      ...
      nome: 'Helena S.',
      color: palette.success,
      desc: 'Esquema vacinal completo para a faixa etária. Matrícula liberada.',
    },
    {
      cpf: '555.666.777-88',
      status: 'EM DIA',
      nome: 'Pedro M.',
      color: palette.primary,
      desc: 'Doses dentro do calendário; próxima dose em 60 dias. Matrícula liberada.',
    },
    {
      cpf: '999.000.111-22',
      status: 'PENDENTE',
      nome: 'Lucas R.',
      color: palette.warn,
      desc: 'Dose em atraso. Matrícula liberada com agendamento orientado na UBS de referência.',
    },
    {
      cpf: '333.444.555-66',
      ...
      nome: 'Mariana T.',
      color: palette.danger,
      desc: 'Sem registro encontrado nas bases consultadas. Necessária regularização via UBS.',
    },
  ];

  const consultar = (exemplo) => {
    setLoading(true);
    setResultado(null);
    setAgendamentoConfirmado(null);
    setCpf(exemplo.cpf);
    setTimeout(() => {
      setResultado(exemplo);
      setLoading(false);
    }, 900);
  };

  const onAgendamentoConcluido = (dados) => {
  ...
  return (
    <SectionWrap palette={palette} alt>
      <SectionHeader
        palette={palette}
        kicker="Demonstração interativa"
        title="Consulta escolar simulada"
        subtitle="Selecione um cidadão fictício para ver o status retornado à secretaria escolar. A Educação vê apenas isto — nunca o histórico."
      />
      <div
      ...
      >
        ...
        <div>
          ...
          >
            Cidadãos demonstrativos (fictícios)
          </div>
            ...
            {exemplos.map((ex, i) => (
              <motion.button
                ...
                style={{
                  ...
                  background: palette.surface,
                  border: `1px solid ${
                    cpf === ex.cpf ? ex.color : palette.border
                  }`,
                  borderRadius: 12,
                  color: palette.text,
                  cursor: 'pointer',
              ...
              >
                <span
                  style={{ fontFamily: 'monospace', color: palette.textMuted }}
                >
                  {ex.cpf}
                </span>
                <ArrowRight size={14} color={ex.color} />
              </motion.button>
            ))}
          </div>
          ...
          >
            <strong style={{ color: palette.accent }}>Dica · Pitch:</strong>{' '}
            exceto LIBERADO, todos os status abrem fluxo de agendamento na UBS —
            cada caso com sua finalidade específica.
          </div>
        </div>
            ...
            {loading ? (
              ...
              >
                <div
                  style={{
                    height: 40,
                    background: `linear-gradient(90deg, ${palette.surfaceAlt}, ${palette.border}, ${palette.surfaceAlt})`,
                ...
                >
                  Consultando banco pseudonimizado…
                </div>
              </motion.div>
            ) : agendamentoConfirmado ? (
              <ConfirmacaoAgendamento
                palette={palette}
                dados={agendamentoConfirmado}
                onReset={() => {
                  setAgendamentoConfirmado(null);
                  setResultado(null);
                  setCpf('');
              ...
              >
                ...
                <h3
                  className="display-font"
                  style={{ fontSize: 32, fontWeight: 500, margin: '0 0 12px' }}
                >
                  {resultado.nome}
                </h3>
                <p
                ...
                <div
                  style={{
                    ...
                    borderLeft: `3px solid ${palette.primary}`,
                    marginBottom:
                      resultado.status === 'NÃO LOCALIZADO' ? 16 : 0,
                  }}
                >
                  <strong style={{ color: palette.text }}>
                    Dado retornado:
                  </strong>{' '}
                  apenas o status. Histórico clínico permanece na Saúde.
                  {openPortal && (
                    <button
                      onClick={() => openPortal('crypto')}
                      style={{
                        display: 'block',
                        marginTop: 8,
                        background: 'transparent',
                    ...
                    >
                      ↳ Como o CPF é protegido?
                    </button>
                  )}
                </div>

                {/* Botão de agendamento — para todos os status exceto LIBERADO */}
                {resultado.status !== 'LIBERADO' && (
                  ...
                  >
                    {resultado.status === 'EM DIA' && 'Agendar próxima dose'}
                    {resultado.status === 'PENDENTE' &&
                      'Agendar dose em atraso'}
                    {resultado.status === 'NÃO LOCALIZADO' &&
                      'Agendar regularização'}
                    <ArrowRight size={16} />
                  </motion.button>
                )}
              </motion.div>
              ...
              >
                Selecione um cidadão demonstrativo ao lado para visualizar a
                resposta.
              </motion.div>
            )}
          </AnimatePresence>
      ...
      <AnimatePresence>
        {showAgendamento && resultado && (
          <ModalAgendamento
            ...
            onConcluir={onAgendamentoConcluido}
          />
        )}
      </AnimatePresence>
      ...
      <style>{`
        @media (max-width: 720px) {
          .consulta-grid { grid-template-columns: 1fr !important; }
        }
      `}</style>
    </SectionWrap>
  );
...
function ModalAgendamento({ palette, cidadao, onClose, onConcluir }) {
  ...
  const ubsOpcoes = [
    {
      ...
      endereco: 'Av. Augusto Franco, 2840 — Aracaju/SE',
      distancia: '1.2 km',
      proxima: true,
    },
    {
      id: 'atalaia',
      nome: 'UBS Atalaia',
      endereco: 'R. Niceu Dantas, 410 — Atalaia, Aracaju/SE',
      distancia: '3.8 km',
      proxima: false,
    },
    {
      id: 'centro',
      nome: 'UBS Centro',
      endereco: 'R. Laranjeiras, 285 — Centro, Aracaju/SE',
      distancia: '5.4 km',
      proxima: false,
    },
  ];
  ...
  const confirmar = () => {
    setEtapa(4);
    setTimeout(() => {
      const protocolo = `VE-${hoje.getFullYear()}-${String(
        ...
        >
          <div>
            ...
            >
              ...
              {cidadao.status === 'NÃO LOCALIZADO' &&
                'Agendamento · Vigilância Epidemiológica'}
            </div>
            <h3
              className="display-font"
              style={{
        ...
        <AnimatePresence mode="wait">
          ...
          {etapa === 2 && (
            ...
            >
              ...
              >
                Próximos 21 dias · {meses[hoje.getMonth()]} /{' '}
                {meses[(hoje.getMonth() + 1) % 12]} {hoje.getFullYear()}
              </div>
              <div
                style={{
                  display: 'grid',
              ...
              >
                ...
                {dias.map((d, i) => {
                  const isSelected =
                    dataSelecionada &&
                    dataSelecionada.dia === d.dia &&
                    dataSelecionada.mes === d.mes;
                  return (
                    <button
                      key={i}
          ...
          {etapa === 3 && (
            ...
            >
              ...
              >
                {dataSelecionada &&
                  `${diasSemana[dataSelecionada.diaSemana]} · ${
                    dataSelecionada.dia
                  } de ${meses[dataSelecionada.mes]}`}
              </div>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                >
                  {horarios
                    .filter((h) => parseInt(h.hora) < 12)
                    .map((h) => (
                      <button
                        key={h.hora}
                        onClick={() =>
                          h.disponivel && setHorarioSelecionado(h.hora)
                        }
...
function ConfirmacaoAgendamento({ palette, dados, onReset }) {
  ...
  return (
    ...
    >
      ...
      >
        Regularização agendada para{' '}
        <span style={{ color: palette.primary }}>
          {dados.data.dia} de {meses[dados.data.mes]}
        </span>
        , às <span style={{ color: palette.primary }}>{dados.horario}</span>
      </h3>
      ...
      >
        <strong style={{ color: palette.text }}>Notificado:</strong>{' '}
        {dados.cidadao.status === 'NÃO LOCALIZADO'
          ? 'Vigilância Epidemiológica + UBS'
          : 'UBS de referência'}
        <br />
        <strong style={{ color: palette.text }}>Status escolar:</strong>{' '}
        matrícula liberada condicionalmente
        <br />
        <strong style={{ color: palette.text }}>Auditoria:</strong> evento
        registrado · timestamp salvo
      </div>
...
// ============================================
// 10. REGISTRO DE SAÚDE SIMULADO
// ============================================
function RegistroSaude({ palette }) {
  const [logs, setLogs] = useState([
    {
      ts: '10:42',
      agent: 'UBS Centro',
      evento: 'Dose Tríplice Viral aplicada',
      cidadao: 'Helena S.',
    },
    {
      ts: '10:38',
      agent: 'UBS Atalaia',
      evento: 'Dose HPV aplicada',
      cidadao: 'Pedro M.',
    },
  ]);
  ...
  const adicionarRegistro = () => {
    ...
    setTimeout(() => {
      ...
      const novos = [
        {
          ts: `${hh}:${mm}`,
          agent: 'UBS Augusto Franco',
          evento: 'Dose Hepatite B aplicada',
          cidadao: 'Lucas R.',
        },
        ...logs,
      ];
      setLogs(novos.slice(0, 6));
      setAdding(false);
    }, 1000);
  };
  ...
  return (
    <SectionWrap palette={palette}>
      <SectionHeader
        palette={palette}
        kicker="Lado da Saúde"
        title="Registro clínico simulado"
        subtitle="A cada dose registrada na UBS, o sistema recalcula o status do cidadão e a auditoria é alimentada automaticamente."
      />
      <div
        style={{
          background: palette.surface,
      ...
      >
        ...
        >
          <div>
            ...
            >
              Eventos clínicos recentes
            </div>
            <div
              style={{ fontSize: 13, color: palette.textMuted, marginTop: 4 }}
            >
              Domínio exclusivo da Secretaria de Saúde
            </div>
          </div>
          <button
          ...
          >
            <Sparkles size={14} />
            {adding ? 'Registrando...' : 'Simular nova dose'}
          </button>
        </div>
            ...
            {logs.map((log, i) => (
              <motion.div
                ...
                style={{
                  ...
                  padding: '14px 18px',
                  background:
                    i === 0 && logs[0].agent === 'UBS Augusto Franco'
                      ? palette.success + '11'
                      : palette.surfaceAlt,
                  borderRadius: 12,
                  border:
                    i === 0 && logs[0].agent === 'UBS Augusto Franco'
                      ? `1px solid ${palette.success}44`
                      : `1px solid transparent`,
                  alignItems: 'center',
                }}
              >
...
function LGPDMinimizacao({ palette, openPortal }) {
  ...
  const tabs = [
    {
      label: 'Finalidade',
      desc: 'Cada acesso ocorre com finalidade pública declarada: validação de matrícula escolar — não diagnóstico, não atendimento clínico.',
      icon: FileCheck,
    },
    {
      label: 'Necessidade',
      desc: 'A Educação não precisa do histórico clínico para autorizar matrícula. Precisa apenas saber se o cidadão está em conformidade.',
      icon: Eye,
    },
    {
      label: 'Minimização',
      desc: 'Apenas 4 estados retornam à Educação: LIBERADO, EM DIA, PENDENTE, NÃO LOCALIZADO. Nada mais.',
      icon: EyeOff,
    },
    {
      label: 'Auditoria',
      desc: 'Toda consulta gera log com agente, finalidade, dado acessado e timestamp — passível de revisão pela autoridade competente.',
      icon: ScrollText,
    },
  ];
  ...
  return (
    <SectionWrap
      ...
      alt
      id="lgpd"
      animation={<LGPDMinimizationAnimation palette={palette} />}
    >
      <SectionHeader
        palette={palette}
        ...
        >
          <AnimatePresence mode="wait">
            ...
            >
              <h3
                className="display-font"
                style={{ fontSize: 32, fontWeight: 500, margin: '0 0 16px' }}
              >
                {tabs[active].label}
              </h3>
              <p
        ...
        {[
          {
            id: 'crypto',
            icon: Lock,
            title: 'Como o CPF é protegido?',
            desc: 'Veja a pseudonimização em ação',
            color: palette.primary,
          },
          {
            id: 'minimization',
            icon: EyeOff,
            title: 'O que é minimização na prática?',
            desc: 'Filtre um prontuário completo passo a passo',
            color: palette.warn,
          },
        ].map((portal) => {
          ...
          return (
            ...
            >
              ...
              <div style={{ flex: 1, position: 'relative' }}>
                ...
                <div
                  className="display-font"
                  style={{ fontSize: 17, fontWeight: 500, marginBottom: 4 }}
                >
                  {portal.title}
                </div>
                <div style={{ fontSize: 12, color: palette.textMuted }}>
...
function AuditoriaDemo({ palette, openPortal }) {
  ...
  const logs = [
    ...
    {
      ts: '13:58:22',
      agent: 'saude.ubs.atalaia.demo',
      finalidade: 'atendimento clínico',
      cidadao: '***222.333**',
      retorno: 'histórico_completo',
      ok: true,
    },
  ...
  return (
    <SectionWrap
      palette={palette}
      animation={<AuditLogsAnimation palette={palette} />}
    >
      <SectionHeader
        palette={palette}
        kicker="Trilha de evidências"
        title="Auditoria demonstrativa"
        subtitle="Todo acesso é logado com finalidade declarada. Tentativas fora do escopo são bloqueadas e registradas."
      />
      <div
        style={{
          background: palette.surface,
      ...
      >
        ...
        >
          ...
          >
            {showBlocked
              ? 'Ocultar tentativa bloqueada'
              : 'Simular tentativa fora do escopo'}
          </button>
        </div>
            ...
            <tbody>
              <AnimatePresence>
                {showBlocked && (
                  ...
                  >
                    <td style={{ padding: '12px 16px' }}>14:03:09</td>
                    <td style={{ padding: '12px 16px' }}>
                      secescolar.aracaju.demo
                    </td>
                    <td
                      style={{
                        padding: '12px 16px',
                    ...
                    <td style={{ padding: '12px 16px' }}>***222.333**</td>
              ...
              {logs.map((log, i) => (
                ...
                >
                  <td
                    style={{ padding: '12px 16px', color: palette.textMuted }}
                  >
                    {log.ts}
                  </td>
                  <td style={{ padding: '12px 16px' }}>{log.agent}</td>
                  <td style={{ padding: '12px 16px' }}>{log.finalidade}</td>
                  <td style={{ padding: '12px 16px' }}>{log.cidadao}</td>
                  <td style={{ padding: '12px 16px' }}>{log.retorno}</td>
                  <td style={{ padding: '12px 16px' }}>
                    <span
                      style={{
                        padding: '3px 10px',
...
function ImpactoSocial({ palette }) {
  ...
  const impactos = [
    {
      stat: '−4h',
      label: 'Tempo médio economizado por família',
      desc: 'Sem deslocamento à UBS exclusivamente para emitir comprovante.',
    },
    {
      stat: '−R$ 18',
      label: 'Custo evitado por matrícula',
      desc: 'Considerando transporte público, impressão e tempo do servidor.',
    },
    {
      stat: '+23%',
      label: 'Adesão estimada à matrícula no prazo',
      desc: 'Pendência deixa de ser barreira e passa a ser orientação.',
    },
  ];
...
// ============================================
function RoteiroApresentacao({ palette }) {
  const [open, setOpen] = useState(0);
  const passos = [
    {
      titulo: 'Abertura — o problema concreto',
      duracao: '1 min',
      conteudo:
        'Apresentar a cena: família, papel, fila, retrabalho. Mostrar que é um problema invisível porque está há décadas na rotina.',
    },
    {
      titulo: 'A virada de chave',
      duracao: '1 min',
      conteudo:
        'A Educação não precisa do histórico — precisa do status. Esta é a inversão conceitual que destrava a solução.',
    },
    {
      titulo: 'A arquitetura proposta',
      duracao: '2 min',
      conteudo:
        'Saúde registra. Sistema calcula. Educação consulta. Banco pseudonimizado como ponte. LGPD por design, não por adendo.',
    },
    {
      titulo: 'Demonstração ao vivo',
      duracao: '2 min',
      conteudo:
        'Consulta escolar, registro de saúde, auditoria. Mostrar o bloqueio de acesso indevido em tempo real.',
    },
    {
      titulo: 'Impacto e próximos passos',
      duracao: '1 min',
      conteudo:
        'Tempo da família, economia, adesão. Caminho de evolução: piloto, integração com cadastros oficiais, expansão para outras secretarias.',
    },
  ];
  ...
  return (
    <SectionWrap palette={palette}>
      <SectionHeader
        ...
        subtitle="Sete minutos para narrar o problema, a virada conceitual e a solução. Cada bloco abre detalhes ao clicar."
      />
      <div
        style={{ maxWidth: 880, margin: '0 auto', display: 'grid', gap: 12 }}
      >
        {passos.map((p, i) => {
          const isOpen = open === i;
          return (
            <motion.div
              ...
              style={{
                background: palette.surface,
                border: `1px solid ${
                  isOpen ? palette.primary : palette.border
                }`,
                borderRadius: 16,
                overflow: 'hidden',
                transition: 'border-color 0.3s',
...
function ArquiteturaDemo({ palette }) {
  ...
  const camadas = [
    {
      nivel: 'Camada de apresentação',
      desc: 'Portal da Educação, app do cidadão, painel da Saúde. Front separado por audiência.',
      icon: Eye,
      color: palette.primary,
    },
    {
      nivel: 'Camada de orquestração',
      desc: 'API Gateway com autenticação por agente, autorização por finalidade e rate limiting.',
      icon: GitBranch,
      color: palette.accent,
    },
    {
      nivel: 'Camada de cálculo',
      desc: 'Serviço que transforma registros clínicos em status objetivo (LIBERADO/EM DIA/PENDENTE/NÃO LOCALIZADO).',
      icon: Activity,
      color: palette.success,
    },
    {
      nivel: 'Camada de dados',
      desc: 'Base clínica isolada na Saúde + base pseudonimizada acessada pela Educação.',
      icon: Database,
      color: palette.primaryDeep,
    },
    {
      nivel: 'Camada de auditoria',
      desc: 'Log imutável transversal a todas as camadas, com finalidade declarada por requisição.',
      icon: ScrollText,
      color: palette.warn,
    },
  ];
  ...
  return (
    <SectionWrap palette={palette} alt>
      ...
      <div
        ref={ref}
        style={{ display: 'grid', gap: 12, maxWidth: 900, margin: '0 auto' }}
      >
        {camadas.map((c, i) => {
          const Icon = c.icon;
          return (
      ...
      >
        ...
        >
          {itens.map((i, idx) => (
            ...
            >
              <span style={{ color: palette.warn, marginTop: 6, fontSize: 8 }}>
                ●
              </span>
              {i}
            </li>
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        ...
        >
          <div>
            ...
            >
              Demonstração visual de governança digital aplicada à integração
